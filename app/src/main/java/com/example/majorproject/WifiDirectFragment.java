...
//
//public class WifiDirectFragment extends Fragment implements ChannelListener, DeviceActionListener {
//
...
//
//        DeviceListFragment fragmentList = (DeviceListFragment) getActivity().getFragmentManager().findFragmentById(R.id.frag_list);
//        DeviceDetailFragment fragmentDetails = (DeviceDetailFragment) getActivity().getFragmentManager().findFragmentById(R.id.device_details);
//
...
//        Log.e(TAG, "showDetails: " + device.deviceAddress );
//        DeviceDetailFragment fragment = (DeviceDetailFragment)getActivity().getFragmentManager().findFragmentById(R.id.frag_detail);
